-- Esquema inicial de la aplicación Encuestas (gestionado por MigrationRunner).
...
-- Para evolucionar el esquema en el futuro, agrega un script nuevo (V0002_...sql); nunca edites este.
...
-- Encuestas creadas por los usuarios. El índice compuesto sirve al filtro por usuario +
-- orden por posición del tablero y, a la vez, satisface la clave foránea sobre p_user_key.
